...
- **[2026-04-13]** **自进化智能体 v2：** 完整的自进化引擎——从历史中挖掘重复工作流并推荐新技能；根据 👎 反馈自动改进技能；技能版本可追溯、可回滚；**成长报告**可视化领域熟练度、效率变化、里程碑与学习时间线。越用越强。
- **[2026-04-02]** **兼容 ClawHub 等平台提供的 skill 包：** 以 `SKILL.md` 为主的压缩包（例如从 [ClawHub](https://clawdhub.com) 下载）可直接导入——在侧栏 **Skills** 中点击 **📦 Import** 上传 `.zip`，即可将指令型技能注入智能体上下文；可在列表中随时启用/禁用或删除。
...
### 🧠 越用越聪明
每完成一项有一定复杂度的任务，TabClaw 都会回顾过程、总结规律，并将其提炼为可复用的**自定义技能**。下次遇到类似问题时可直接调用，省去重复摸索。技能支持**版本化**与基于反馈的**自动改进**；**成长报告**汇总领域熟练度、效率、里程碑与时间线，直观展示自主进化轨迹。

<p align="center"><img src="asset/skill.png" alt="技能学习" width="75%" /></p>

**成长报告（自主进化）** — 领域熟练度、效率变化、里程碑与学习时间线。

<p align="center"><img src="asset/grow.png" alt="成长报告" width="75%" /></p>

**进化过程中新生成的技能** — 当模式重复、反馈积累时，系统会提示可采纳的新技能或升级后的技能包。

<p align="center"><img src="asset/new_skill.PNG" alt="进化中新生成的技能" width="75%" /></p>
